  ...
  return (
    <div className='w-screen aspect-video pt-[10%] px-4 md:px-20 absolute text-white bg-gradient-to-r from-black'>
      ...
      <div className='mt-6 md:mt-0 py-6 flex'>
        <button className='bg-white flex text-black py-2 md:py-4 px-3 items-center flex-row md:px-12 rounded-md text-xl font-bold hover:bg-opacity-50' > <img className='w-5 mr-2'alt='' src='/play.png'></img> <span> Play</span></button>
